...
Object.assign(translations.ar, {
  ...
  catalog_switch_new: 'جديد',
  catalog_switch_refurb: 'مجدد',
  catalog_page_title: 'كتالوج الأجهزة',
  catalog_page_desc: 'ابحث في كل الأجهزة الجديدة والمجددة من مكان واحد.',
  catalog_results_title: 'نتائج البحث',
  catalog_results_desc: 'الأجهزة المطابقة لكلمة البحث الحالية.',
  catalog_tab_all: 'الكل',
  catalog_tab_new: 'جديدة بضمان الوكيل',
  catalog_tab_refurb: 'مجددة فحص 40 نقطة',
  catalog_empty_title: 'لم نتمكن من العثور على أجهزة مطابقة لبحثك',
  catalog_empty_desc: 'جرّب كلمة أخرى، أو أعد ضبط الفلاتر لعرض الكتالوج كاملاً.',
  catalog_empty_reset: 'إعادة ضبط البحث',
  catalog_view_grid: 'عرض شبكي',
  catalog_view_list: 'عرض قائمة',
  catalog_device_type: 'نوع الجهاز',
  ...
  pdp_in_stock: 'متوفر في المخزن',
  pdp_condition: 'اختر حالة الجهاز',
  pdp_grade_guide: 'دليل التصنيف',
  pdp_color: 'اللون المحدد',
  pdp_storage: 'السعة التخزينية',
  pdp_installment: 'التقسيط الميسر بدون فوائد',
  pdp_add_cart: 'إضافة إلى السلة',
  pdp_buy_now: 'شراء فوري',
  pdp_tab_specs: 'المواصفات',
  pdp_tab_reviews: 'المراجعات',
  pdp_tab_warranty: 'الضمان والاستبدال',
  pdp_bundle_title: 'منتجات تُشترى غالباً معه',
  pdp_related: 'منتجات مشابهة',
  pdp_not_found_title: 'هذا المنتج غير متوفر حالياً',
  pdp_not_found_desc: 'قد يكون الرابط قديماً أو المنتج غير مربوط بعد بلوحة التحكم.',
  pdp_back_catalog: 'العودة إلى الكتالوج',
  cart_page_title: 'سلة المشتريات',
  cart_empty_title: 'سلة المشتريات فارغة حالياً',
  cart_empty_desc: 'أضف أجهزة من الكتالوج أو المفضلة، والمحتوى يبقى محفوظاً على جهازك.',
  checkout_page_title: 'الشحن والدفع',
  success_page_title: 'تم تأكيد طلبك',
  wishlist_page_title: 'المفضلة',
...
Object.assign(translations.en, {
  ...
  catalog_switch_new: 'New',
  catalog_switch_refurb: 'Refurbished',
  catalog_page_title: 'Device Catalog',
  catalog_page_desc: 'Search every new and refurbished device in one place.',
  catalog_results_title: 'Search results',
  catalog_results_desc: 'Devices matching your current search.',
  catalog_tab_all: 'All',
  catalog_tab_new: 'New with warranty',
  catalog_tab_refurb: 'Certified refurbished',
  catalog_empty_title: 'We could not find devices matching your search',
  catalog_empty_desc: 'Try another keyword, or reset the filters to view the full catalog.',
  catalog_empty_reset: 'Reset search',
  catalog_view_grid: 'Grid view',
  catalog_view_list: 'List view',
  catalog_device_type: 'Device type',
  ...
  pdp_condition: 'Choose condition',
  pdp_grade_guide: 'Grade guide',
  pdp_color: 'Selected color',
  pdp_storage: 'Storage',
  pdp_installment: 'Interest-free installments',
  pdp_add_cart: 'Add to cart',
  pdp_buy_now: 'Buy now',
  pdp_tab_specs: 'Specifications',
  pdp_tab_reviews: 'Reviews',
  pdp_tab_warranty: 'Warranty & returns',
  pdp_bundle_title: 'Frequently bought together',
  pdp_related: 'Related products',
  pdp_not_found_title: 'This product is not available',
  pdp_not_found_desc: 'The link may be outdated, or the product is not connected yet.',
  pdp_back_catalog: 'Back to catalog',
  cart_page_title: 'Shopping cart',
  cart_empty_title: 'Your cart is empty',
  cart_empty_desc: 'Add devices from the catalog or wishlist. Your items stay saved on this device.',
  checkout_page_title: 'Checkout',
  success_page_title: 'Order confirmed',
